...
export const deleteCommentStart = actionCreator('DELETE_START');
...
export const patchCommentStart = actionCreator('PATCH_START');
export const patchCommentSuccess = actionCreator<{ postId: number; commentId: number; body: string }>('PATCH_SUCCESS');
